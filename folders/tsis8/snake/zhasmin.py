...
def generate_food(snake_list):
    while True:
        foodx = round(random.randrange(2, 26)) * 25.0
        foody = round(random.randrange(2, 22)) * 25.0
        foodx1 = round(random.randrange(2, 26)) * 25.0
        foody1 = round(random.randrange(2, 22)) * 25.0
        foodx2 = round(random.randrange(2, 26)) * 25.0
        foody2 = round(random.randrange(2, 22)) * 25.0
        for x in snake_list:
            if x[0] == foodx and x[1] == foody:
                ...
                return foodx, foody
        for x in snake_list:
            if x[0] == foodx1 and x[1] == foody1:
                break
            else:
                return foodx1, foody1
        for x in snake_list:
            if x[0] == foodx2 and x[1] == foody2:
                break
            else:
                return foodx2, foody2
